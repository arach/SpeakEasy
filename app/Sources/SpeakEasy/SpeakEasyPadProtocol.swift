...
struct SpeakEasyPadRemoteSnapshot: Codable, Equatable, Sendable {
    ...
    func hasSameConflictState(as other: Self) -> Bool {
        phase == other.phase
            ...
            && playback.volume == other.playback.volume
            && playback.playbackRate == other.playback.playbackRate
            && playback.autoplayEnabled == other.playback.autoplayEnabled
    ...
    func hasSameBroadcastState(as other: Self) -> Bool {
        hasSameConflictState(as: other)
            ...
            && playback.audioLevel == other.playback.audioLevel
    }
}
