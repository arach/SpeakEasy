...
export const metadata: Metadata = {
  ...
  description:
    "Complete documentation for SpeakEasy text-to-speech service including CLI, SDK, configuration, and troubleshooting guides.",
}
...
export default async function DocsPage() {
  ...
  const sections = groupDocNavPages(navItems)
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-slate-900 mb-4">Complete SpeakEasy Documentation</h2>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Everything you need to integrate text-to-speech into your applications. From CLI commands
            to SDK usage, configuration, and troubleshooting.
          </p>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-slate-200 text-center">
          <p className="text-sm text-slate-600">
            ...
            or run{" "}
            <code className="px-2 py-1 bg-slate-100 rounded text-xs font-mono">speakeasy --doctor</code>{" "}
            for diagnostics.
          </p>
        </div>
      </div>
