            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
              <div className="text-center">
                <a 
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-xl border border-slate-200 hover:border-blue-300 hover:bg-blue-50 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group cursor-pointer"
                  title="Visit @arach/hooked on GitHub (opens in new tab)"
                >
                  <svg className="w-8 h-8 group-hover:scale-110 transition-transform duration-200" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm font-medium group-hover:text-blue-700 transition-colors">@arach/hooked</span>
                  <ExternalLink className="w-4 h-4 opacity-50 group-hover:opacity-100 group-hover:scale-110 transition-all duration-200 text-blue-600" />
                </a>
                <p className="text-xs text-slate-500 mt-2 group-hover:text-slate-600 transition-colors">Ready-to-deploy handlers</p>
              </div>
              ...
              <div className="text-center">
                <a 
                  ...
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-xl border border-slate-200 hover:border-blue-300 hover:bg-blue-50 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group cursor-pointer"
                  title="Visit Claude Code Hooks documentation (opens in new tab)"
                >
                  <img src="https://wpforms.com/wp-content/uploads/2024/08/claude-logo.png" alt="Claude" className="w-8 h-8 group-hover:scale-110 transition-transform duration-200" />
                  <span className="text-sm font-medium group-hover:text-blue-700 transition-colors">Claude Hooks</span>
                  <ExternalLink className="w-4 h-4 opacity-50 group-hover:opacity-100 group-hover:scale-110 transition-all duration-200 text-blue-600" />
                </a>
                <p className="text-xs text-slate-500 mt-2 group-hover:text-slate-600 transition-colors">Official documentation</p>
              </div>
            </div>
          </div>
        </div>
