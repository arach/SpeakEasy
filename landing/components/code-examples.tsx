...
import { Copy, Check, Terminal, Settings, Volume2 } from "lucide-react"
    ...
    <section className="py-12 px-4 bg-slate-50/50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <Badge variant="outline" className="mb-4 border-emerald-200 text-emerald-700 bg-emerald-50/80 backdrop-blur-sm">
            <Terminal className="w-3 h-3 mr-2" />
            Usage Examples
          </Badge>
          <h2 className="font-display text-4xl md:text-5xl font-extralight mb-6 text-slate-900">
            Start Speaking in 
            <span className="font-light bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent"> Seconds</span>
          </h2>
              ...
              <Card className="relative bg-slate-900 border-slate-700 overflow-hidden rounded-xl shadow-lg">
                <div className="flex items-center justify-between px-2 py-1 bg-slate-800 border-b border-slate-700">
                  ...
                  <Button
                    ...
                    className="text-slate-400 hover:text-white hover:bg-slate-700 h-6 w-6 p-0 rounded-md"
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-4 p-4 bg-emerald-50 rounded-2xl border border-emerald-200">
            <div className="w-8 h-8 bg-emerald-100 rounded-full flex items-center justify-center">
              <Terminal className="w-4 h-4 text-emerald-600" />
            </div>
            <div className="text-left">
              <div className="font-medium text-emerald-900">Quick Install</div>
              <code className="text-sm text-emerald-700 font-mono">npm install @arach/speakeasy</code>
            </div>
          </div>
        </div>
      </div>
