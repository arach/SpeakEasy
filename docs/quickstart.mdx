...
- **macOS** for system voice, the menu-bar player (`speakeasy --app`), and optional listening mode
...
# Open the macOS menu-bar player (installs signed app if needed)
speakeasy --app
```

Thread-locked Codex listening mode and the dedicated microphone picker live in the app popover once you have a build that includes them — see [Listening mode](./listening-mode).
